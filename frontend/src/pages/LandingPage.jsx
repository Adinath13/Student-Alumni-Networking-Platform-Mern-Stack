                        ...
                        <main className="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
                            <div className="sm:text-center lg:text-left">
                                <h1 className="text-4xl tracking-tight font-extrabold text-white sm:text-5xl md:text-6xl">
                                    ...
                                    <span className="block text-indigo-200 xl:inline">Alumni Network</span>
                                </h1>
                                <p className="mt-3 text-base text-indigo-100 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0">
                                    Bridge the gap between students and alumni. Find mentorship, job opportunities, events, and stay connected with your alma mater.
                                </p>
                        ...
                        <dl className="space-y-10 md:space-y-0 md:grid md:grid-cols-2 md:gap-x-8 md:gap-y-10">
                            <div className="relative">
                                ...
                                <dd className="mt-2 ml-16 text-base text-gray-500">
                                    Search and connect with alumni from various batches and industries.
                                </dd>
                            </div>
                            ...
                            <div className="relative">
                                <dt>
                                    ...
                                    <p className="ml-16 text-lg leading-6 font-medium text-gray-900">Events & Reunions</p>
                                </dt>
                                <dd className="mt-2 ml-16 text-base text-gray-500">
                                    Stay updated with upcoming webinars, workshops, and alumni meets.
                                </dd>
                            </div>
                            ...
                            <div className="relative">
                                ...
                                <dd className="mt-2 ml-16 text-base text-gray-500">
                                    Find exclusive job opportunities and internships posted by alumni.
                                </dd>
                            </div>
                            ...
                            <div className="relative">
                                ...
                                <dd className="mt-2 ml-16 text-base text-gray-500">
                                    Get guidance from experienced seniors in your field of interest.
                                </dd>
                            </div>
                        </dl>
                    </div>
